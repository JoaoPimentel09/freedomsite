    ...
    <main className="min-h-screen">
        ...
        <div className="container mx-auto px-4 pt-[60px] pb-6 md:py-20 flex flex-col md:flex-row items-start md:items-center relative z-10">
          ...
          <div className="md:w-1/2 space-y-3 md:space-y-6 flex flex-col items-center md:items-start">
            ...
            <div className="text-center md:text-left">
              ...
              <h2 className="text-lg md:text-3xl font-bold text-white">COM MENOR PREÇO EM SANTA CATARINA</h2>
            </div>
            ...
            <p className="text-gray-300 max-w-[650px] text-base md:text-lg leading-relaxed text-center md:text-left">
              Revenda a melhor solução em Baterias Estacionárias do Brasil em Santa Catarina,
          ...
          <div className="max-w-3xl mx-auto">
            <Accordion type="single" collapsible defaultValue="item-1" className="w-full">
              ...
              <AccordionItem value="item-3">
                <AccordionTrigger>A distribuidora fica em Santa Catarina?</AccordionTrigger>
                <AccordionContent>
                  Temos distribuição em Curitiba e São Paulo e enviamos seu pedido para Santa Catarina no mesmo dia.
                </AccordionContent>
              </AccordionItem>
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="mt-4 text-gray-400">Distribuição para Santa Catarina</p>
        </div>
      </footer>
