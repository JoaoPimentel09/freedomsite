...
export default function FreedomWhite() {
  return (
    <main className="min-h-screen">
      {/* Hero Section com fundo branco */}
      <section className="relative bg-white text-black overflow-hidden min-h-[700px] md:min-h-[800px] flex items-start md:items-center">
        <div className="container mx-auto px-4 pt-[60px] pb-6 md:py-20 flex flex-col md:flex-row items-start md:items-center relative z-10">
          <div className="md:w-1/2 space-y-3 md:space-y-6 flex flex-col items-center md:items-start">
            ...
            <div className="text-center md:text-left">
              <h2 className="text-lg md:text-3xl font-bold text-gray-800">DISTRIBUIDORA DE</h2>
              <h1 className="text-xl md:text-4xl font-bold text-red-600">BATERIAS FREEDOM</h1>
              <h2 className="text-lg md:text-3xl font-bold text-gray-800">COM MENOR PREÇO EM SÃO PAULO</h2>
            </div>
            ...
            <p className="text-gray-600 max-w-[650px] text-base md:text-lg leading-relaxed text-center md:text-left">
              Revenda a melhor solução em Baterias Estacionárias do Brasil,
